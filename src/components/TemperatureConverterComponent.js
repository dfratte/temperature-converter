...
export const enableKelvinToFahrenheit = false;
...
const TemperatureConverterComponent = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.github.com/repos/dfratte/temperature-converter/commits/main"
      )
      .then((response) => {
        setLastCommitDate(
          new Date(response.data.commit.author.date).toLocaleString()
        );
      })
    ...
    <div className="temperature-converter">
      ...
      <div className="form-container">
        <div className="conversion-container">
          <p>
            Select a conversion type, enter a temperature, and click Convert
          </p>
          <select
        ...
        <div className="button-container">
          <button data-testid="convert-button" onClick={convert}>
            Convert
          </button>
        </div>
